...
public class ConstHttpProp {
	...
	public static final int TYPE_JSONARRAY = 1001;
	...
	public static final String ANMOCODE = "massagecode";
	public static final String DIANJIUCODE = "electrocode";
	public static final String IRISCODE = "iriscode";
	public static final String WNEDUCODE = "thermometercode";
	public static final String XUEYACODE = "bloodpressurecode";
	public static final String XUETANGCODE = "bloodglucosecode";
	public static final String TIZHONGCODE = "weightcode";
	public static final String XINDIANCODE = "ecgcode";
