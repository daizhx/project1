...
public class ErrorActivity extends Activity {
	...
	private void doPost(String s, JSONObject jsonobject)
	{
		...
		httpsetting.setListener(new HttpGroup.OnAllListener() {
			...
			{
				if (Log.D) { 
					Log.d("ErrorActivity", "doPost.HttpGroup.OnAllListener.restart");
				}
			...
			{
				if (Log.D) { 
					Log.d("ErrorActivity", "doPost.HttpGroup.OnAllListener.onEnd");
				}
				restart();
			}
			...
			{
				if (Log.D) { 
					Log.d("ErrorActivity", "doPost.HttpGroup.OnAllListener.onError");
				}
				restart();
			}
	...
	private void onDialog(View view)
	{
		...
		builder.setPositiveButton(R.string.app_error_submit, new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialoginterface, int i)
			{
				myOnClick(DialogInterface.BUTTON_POSITIVE);
			}
		});
		builder.setNegativeButton(R.string.app_error_close, new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialoginterface, int i)
			{
				myOnClick(DialogInterface.BUTTON_NEGATIVE);
			}
		...
		((TextView) window.findViewById(R.id.msgtv)).setText(msg);
		((Button) window.findViewById(R.id.btn3)).setVisibility(View.GONE);
		((LinearLayout) window.findViewById(R.id.msgtv)).setVisibility(View.VISIBLE);
		...
		alertDialog.setOnKeyListener(new OnKeyListener() {
			...
			@Override
			public boolean onKey(DialogInterface arg0, int i, KeyEvent arg2) {
				// TODO Auto-generated method stub
				switch(i){
				case KeyEvent.KEYCODE_BACK:
					return true;
	...
	private void onSubmitError()
	{
		...
		try {
			...
			loading = ProgressDialog.show(this, null, getString(R.string.app_error_tag_send));
	...
	protected void onCreate(Bundle bundle)
	{
		...
		//{
			...
			findViewById(R.id.linearLayout_button_error).setVisibility(View.VISIBLE);
		...
		//{
			...
			//findViewById(R.id.common_title).setVisibility(View.GONE);
			//View view = View.inflate(this, R.layout.app_error_activity, null);
			//editText = (EditText)view.findViewById(R.id.editText_text_error);
			//checkBox = (CheckBox)view.findViewById(R.id.checkBox_restart_error);
